...
public enum Messages {
    ...
    public static final String INVALID_NAME ="Invalid Parking name must be be between 2 and 30 characters";

    public static final String INVALID_STREET ="Invalid Street must be between 2 and 40 characters";
